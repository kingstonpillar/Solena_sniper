...
// Uses ONLY public APIs (Birdeye + Jupiter) — NO Solana RPC

import fetch from "node-fetch";

// --- CONFIG (UPDATED) ---
const BASE_LIQUIDITY_USD = 15000;     // Minimum acceptable liquidity
const SAFE_LIQUIDITY_USD = 20000;     // Strong token liquidity

const MIN_UNIQUE_WALLETS = 3;         // Required unique buyers
const MIN_BUY_VOLUME_USD = 200;       // Minimum buy volume
...
export async function verifyTokenSecurity(mint) {
  ...
  try {
    ...
    // =====================================================
    // 3️⃣ Honeypot check via Jupiter pricing
    // =====================================================
    try {
