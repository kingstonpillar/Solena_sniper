...
async function runMockAutoBuyTests() {
  console.log("=============== MOCK AUTOBUY TEST SUITE ================");

  const realFetch = fetchTokenPriceUSD;
  const realSwap = executeSwap;

  console.log("[A1] Momentum reached test");
  ...
  console.log("=============== MOCK AUTOBUY TEST SUITE COMPLETE ================");
}